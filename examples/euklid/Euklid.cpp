...
bool Euklid::initHardware()
{
  ...
  getDevice(0)->setLed(DeviceBase::Key::Key1, kEuklidColor_Track[0]);
...
void Euklid::buttonChanged(DeviceBase::Button button_, bool buttonState_, bool shiftState_)
{
  if (button_ == DeviceBase::Button::F1)
  {
  ...
  else if (button_ == DeviceBase::Button::F2)
  {
    if (getScreenPage() == Euklid::ScreenPage::Configuration)
    {
  ...
  else if (button_ == DeviceBase::Button::F3)
  {
  ...
  else if (buttonState_ && (button_ == DeviceBase::Button::Group || button_ == DeviceBase::Button::Browse))
  {
    changeTrack();
  }
  else if (buttonState_ && button_ == DeviceBase::Button::PageLeft)
  {
    prevTrack();
  }
  else if (buttonState_ && button_ == DeviceBase::Button::PageRight)
  {
    nextTrack();
  }
  else if (buttonState_ && button_ == DeviceBase::Button::GroupA)
  {
    changeTrack(0);
  }
  else if (buttonState_ && button_ == DeviceBase::Button::GroupB)
  {
    changeTrack(1);
  }
  else if (buttonState_ && button_ == DeviceBase::Button::GroupC)
  {
    changeTrack(2);
  }
  else if ((button_ == DeviceBase::Button::Play || button_ == DeviceBase::Button::Sync) && buttonState_)
  {
    togglePlay();
  }
  else if (button_ == DeviceBase::Button::Control && buttonState_)
  {
    setScreenPage(getScreenPage() == Euklid::ScreenPage::Configuration
                                  ? Euklid::ScreenPage::Sequencer
                                  : Euklid::ScreenPage::Configuration);
  }
  else if(button_ >= DeviceBase::Button::Pad1 && button_ <= DeviceBase::Button::Pad16 && buttonState_)
  {
    uint8_t padIndex = static_cast<uint8_t>(button_) - static_cast<uint8_t>(DeviceBase::Button::Pad1 );
...
void Euklid::encoderChanged(DeviceBase::Encoder encoder_, bool valueIncreased_, bool shiftPressed_)
{
  uint8_t step = (shiftPressed_ ? 5 : 1);
  switch(encoder_)
  {
    case DeviceBase::Encoder::Encoder1:
    {
    ...
    case DeviceBase::Encoder::Main:
    {
      setEncoder(valueIncreased_, shiftPressed_);
      break;
    }
    case DeviceBase::Encoder::Encoder2:
    {
    ...
    case DeviceBase::Encoder::Encoder3:
    {
    ...
    case DeviceBase::Encoder::Encoder4:
    {
      m_bpm = getEncoderValue(valueIncreased_, step, m_bpm, 60, 255);
      updateClock();
      break;
    }
    case DeviceBase::Encoder::Encoder5:
    {
...
void Euklid::padChanged(DeviceBase::Pad pad_, uint16_t value_, bool shiftPressed_)
{
...
void Euklid::keyChanged(DeviceBase::Key key_, uint16_t value_, bool shiftPressed_)
{
  static auto lastEvent = std::chrono::system_clock::now();
  auto now = std::chrono::system_clock::now();
  if (now - lastEvent > std::chrono::milliseconds(180))
...
void Euklid::updateGroupLeds()
{
  ...
  {
  case 0:
    getDevice(0)->setLed(DeviceBase::Button::Group, kEuklidColor_Track_CurrentStep[0]);
    getDevice(0)->setLed(DeviceBase::Button::GroupA, kEuklidColor_Track_CurrentStep[0]);
    getDevice(0)->setLed(DeviceBase::Button::GroupB, kEuklidColor_Black);
    getDevice(0)->setLed(DeviceBase::Button::GroupC, kEuklidColor_Black);
    break;
  case 1:
    getDevice(0)->setLed(DeviceBase::Button::Group, kEuklidColor_Track_CurrentStep[1]);
    getDevice(0)->setLed(DeviceBase::Button::GroupA, kEuklidColor_Black);
    getDevice(0)->setLed(DeviceBase::Button::GroupB, kEuklidColor_Track_CurrentStep[1]);
    getDevice(0)->setLed(DeviceBase::Button::GroupC, kEuklidColor_Black);
    break;
  case 2:
    getDevice(0)->setLed(DeviceBase::Button::Group, kEuklidColor_Track_CurrentStep[2]);
    getDevice(0)->setLed(DeviceBase::Button::GroupA, kEuklidColor_Black);
    getDevice(0)->setLed(DeviceBase::Button::GroupB, kEuklidColor_Black);
    getDevice(0)->setLed(DeviceBase::Button::GroupC, kEuklidColor_Track_CurrentStep[2]);
    break;
  }
}
...
{  
  for (uint8_t t = 0; t < kEuklidNumTracks; t++)
  {
    ...
    {
      DeviceBase::Pad pad = getPad(i);
      DeviceBase::Key key = static_cast<DeviceBase::Key>(i);
...
void Euklid::drawConfigurationPage()
{
  ...
  getDevice(0)->setLed(DeviceBase::Button::F1, 0);
  getDevice(0)->setLed(DeviceBase::Button::F2, 0);
  getDevice(0)->setLed(DeviceBase::Button::F3, 0);
  getDevice(0)->setLed(DeviceBase::Button::Control, 255);
  ...
  switch (m_encoderState)
  {
    case EncoderState::Shuffle:
    {
      getDevice(0)->getGraphicDisplay(0)->drawFilledRect(41, 0, 52, 20, Canvas::Color::Invert,
                                                  Canvas::Color::Invert);
      getDevice(0)->setLed(DeviceBase::Button::F2, 255);
      break;
    }
    case EncoderState::Speed:
    {
      getDevice(0)->getGraphicDisplay(0)->drawFilledRect(0, 0, 40, 20, Canvas::Color::Invert,
                                                  Canvas::Color::Invert);
      getDevice(0)->setLed(DeviceBase::Button::F1, 255);
      break;
    }
    default:
      break;
...
void Euklid::drawSequencerPage()
{
  ...
  getDevice(0)->setLed(DeviceBase::Button::F2, 0);
  getDevice(0)->setLed(DeviceBase::Button::F3, 0);
  getDevice(0)->setLed(DeviceBase::Button::Control, 0);
  ...
  switch (m_encoderState)
  {
    ...
    case EncoderState::Rotate:
    {
      getDevice(0)->getGraphicDisplay(0)->drawFilledRect(86, 0, 40, 10, Canvas::Color::Invert,
                                                  Canvas::Color::Invert);
      getDevice(0)->setLed(DeviceBase::Button::F3, 255);
      break;
    }
...
void Euklid::togglePlay()
{
  ...
  if (m_play)
  {
    getDevice(0)->setLed(DeviceBase::Button::Play, 255);
    m_clockFuture = std::async(std::launch::async, std::bind(&Euklid::play, this));
  }
  else
  {
    getDevice(0)->setLed(DeviceBase::Button::Play, 0);
    m_clockFuture.get();
    for (uint8_t t = 0; t < kEuklidNumTracks; t++)
    {
      m_sequences[t].reset();
...
DeviceBase::Pad Euklid::getPad(uint8_t padIndex_)
{
  switch (padIndex_)
  {
    case 0:  return DeviceBase::Pad::Pad13;
    case 1:  return DeviceBase::Pad::Pad14;
    case 2:  return DeviceBase::Pad::Pad15;
    case 3:  return DeviceBase::Pad::Pad16;
    case 4:  return DeviceBase::Pad::Pad9;
    case 5:  return DeviceBase::Pad::Pad10;
    case 6:  return DeviceBase::Pad::Pad11;
    case 7:  return DeviceBase::Pad::Pad12;
    case 8:  return DeviceBase::Pad::Pad5;
    case 9:  return DeviceBase::Pad::Pad6;
    case 10: return DeviceBase::Pad::Pad7;
    case 11: return DeviceBase::Pad::Pad8;
    case 12: return DeviceBase::Pad::Pad1;
    case 13: return DeviceBase::Pad::Pad2;
    case 14: return DeviceBase::Pad::Pad3;
    case 15: return DeviceBase::Pad::Pad4;
  }
  return DeviceBase::Pad::Unknown;
}
//--------------------------------------------------------------------------------------------------

uint8_t Euklid::getPadIndex(DeviceBase::Pad pad_)
{
  switch (pad_)
  {
    case DeviceBase::Pad::Pad13: return 0;
    case DeviceBase::Pad::Pad14: return 1;
    case DeviceBase::Pad::Pad15: return 2;
    case DeviceBase::Pad::Pad16: return 3;
    case DeviceBase::Pad::Pad9:  return 4;
    case DeviceBase::Pad::Pad10: return 5;
    case DeviceBase::Pad::Pad11: return 6;
    case DeviceBase::Pad::Pad12: return 7;
    case DeviceBase::Pad::Pad5:  return 8;
    case DeviceBase::Pad::Pad6:  return 9;
    case DeviceBase::Pad::Pad7:  return 10;
    case DeviceBase::Pad::Pad8:  return 11;
    case DeviceBase::Pad::Pad1:  return 12;
    case DeviceBase::Pad::Pad2:  return 13;
    case DeviceBase::Pad::Pad3:  return 14;
    case DeviceBase::Pad::Pad4:  return 15;
    default: return 0;
  }
  return 0;
}
