...
public:
  ...
  void onButtonChanged(object fn_){ m_onButtonChanged = fn_; }
  void onEncoderChanged(object fn_){ m_onEncoderChanged = fn_; }
  void onPadChanged(object fn_){ m_onPadChanged = fn_; }
  void onKeyChanged(object fn_){ m_onKeyChanged = fn_; }
  ...
  GDisplay* displayGraphic(size_t displayIndex_){ return device()->displayGraphic(displayIndex_); }
