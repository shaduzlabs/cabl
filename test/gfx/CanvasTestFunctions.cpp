...
void bitmap(Canvas* c_)
{
  ...
  uint8_t bmp_1[] = { 0x03, 0xC0, 0x0C, 0x30, 0x30, 0x0C, 0x41, 0x82, 0x41, 0x82, 0x30, 0x0C, 0x0C, 0x30, 0x03, 0xC0 };
  uint8_t bmp_2[] = {
  ...
  for(unsigned i = 0; i<w; i+=16)
  {
    ...
    {
      c_->bitmap(i, j, 16, 8, bmp_1, {0x44, static_cast<uint8_t>(j*2), static_cast<uint8_t>(i*2)});
    }
  }
